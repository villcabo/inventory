...
namespace humhub\modules\inventory\widgets;
 ...
 * @author luke
 */
class InventoryMenu extends \humhub\widgets\BaseMenu
{

    public $template = "@humhub/widgets/views/leftNavigation";
    public $type = "inventoryNavigation";
    ...
    public function init()
    {
        ...
        $this->addItemGroup(array(
            'id' => 'manage',
            'label' => \Yii::t('AdminModule.widgets_AdminMenuWidget', 'Menú de <strong>Inventario</strong>'),
            'sortOrder' => 100,
        ));
